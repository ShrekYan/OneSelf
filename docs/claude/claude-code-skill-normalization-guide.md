# Claude Code SKILL 规范化编写范式

> **系列前言**：本文是《Claude Code 实战指南》系列中关于 **Skill 规范化编写** 的一篇。之前的文章主要演示了 Agent 与 Skill 的“用法”，而本文重点讲解如何**规范化地编写 Skill**，让工程规范能够稳定、可复用地沉淀下来。
>
> 姊妹篇地址：
>
...
- `.template/skills/skills-template-overview.md`

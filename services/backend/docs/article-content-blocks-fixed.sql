...
-- 修复版本：添加数据库选择，修正编码和引号转义
-- 30 篇文章 × 约 12-14 块 = 共 420 条记录
-- ============================================
...
INSERT INTO `article_content_blocks` (`id`, `article_id`, `block_type`, `content`, `sort_order`, `created_at`, `updated_at`) VALUES
  ...
  ('block-17-11', 'article-17', 'text', '移动端 H5 性能比 PC 端更重要。手机网络不一定好，CPU 算力也不如电脑，性能优化更重要。', 11, UNIX_TIMESTAMP(NOW()) * 1000, UNIX_TIMESTAMP(NOW()) * 1000),

...
<!-- 按模块引入拆分后的规范 -->
include: h5-frontend-developer/architecture-directory.md
include: h5-frontend-developer/page-directory-structure.md
include: h5-frontend-developer/ui-component-spec.md
include: h5-frontend-developer/logic-data-flow.md
